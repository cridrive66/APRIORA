...
class ConsumptionSelection:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ConsumptionSelection_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ConsumptionSelection', message)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = ConsumptionSelectionDialog()
        ...
        if result:
            ...
            filters = self.dlg.get_selected_filters()
            print("User selected filters:", filters)
