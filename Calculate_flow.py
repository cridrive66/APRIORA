...
class CalculateFlow(QgsProcessingAlgorithm):
    ...
    # 'Null' means: estimate parameters on the spot from the gauged subcatchments
    REGION_OPTIONS = [
        'Null (estimate parameters from gauged subcatchments)',
        'Warnow catchment (Germany)',
        # 'Leba catchment (Poland)',
        # 'Kyroenjoki catchment (Finland)',
        # 'Berze catchment (Latvia)',
        # 'Kaevlingean catchment (Sweden)',
        # 'Average of all',
    ]
    REGION_TO_PREFIX = {
        'Warnow catchment (Germany)': 'Warnow',
        'Leba catchment (Poland)': 'Leba',
        'Kyroenjoki catchment (Finland)': 'Kyroenjoki',
        'Berze catchment (Latvia)': 'Berze',
        'Kaevlingean catchment (Sweden)': 'Kaevlingean',
    }
    ...
    def initAlgorithm(self, config):
        ...
        self.addParameter(
            QgsProcessingParameterEnum(
                ...
                self.tr('Pre-trained model region (select "Null" to estimate parameters from gauged catchments)'),
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        def flow_estimation(flow, final_output):
            ...
            if selected_region == 'Null (estimate parameters from gauged subcatchments)':
                ...
                if selected_region == 'Average of all':
        ...
        for flow_field, acc_field in [("Mean_Flow", "calc_Mean_"), ("M_Low_Flow", "calc_M_Low")]:
